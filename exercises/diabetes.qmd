...
Below is a subset of the data key to help us best understand the variables in the dataset that we are going to work with for this programming exercise. If you would like to see the entire data key, please expand the `data key` menu.
