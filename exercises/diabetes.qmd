...
webr:
  ...
  cell-options:
    autorun: false
  resources:
    - https://raw.githubusercontent.com/data-science-with-r/modeling-inference/refs/heads/main/exercises/data/diabetes.csv?token=GHSAT0AAAAAAC7ZGKFKE27CWZQTYYADWCEE2FLMPJA
---

** I can't get the data to load in for webr
...
diabetes <- read_csv("https://raw.githubusercontent.com/data-science-with-r/modeling-inference/refs/heads/main/exercises/data/diabetes.csv?token=GHSAT0AAAAAAC7ZGKFKE27CWZQTYYADWCEE2FLMPJA")
...
Below is a data key regarding a subset of the original data set in the `faraway` package to help us best understand the variables in the dataset that we are going to work with for this programming exercise.
...
Now, let's use R to calculate the coefficients associated with the line of best fit your created above. See the R code and output below. 
...
Why are some estimates so small?
:::
