...
#| echo: false
#| message: false
ggplot(nba, aes(x = Age, y = Salary, color = Position)) +
  geom_point() +
  geom_smooth(method = "lm", se = F) +
  labs(
    title = "Salary by Age and Position",
...
- Regression output has a baseline group when one predictor variable is categorical. This can be found in the `Intercept` term, with the other categorical level coefficients representing the deviation from the baseline.
